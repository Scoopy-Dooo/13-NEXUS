...
export default function PostCard({ post, details }) {
    ...
    const postTextDir = /^[\u0600-\u06FF]/.test(post?.body?.trimStart()) ? 'rtl' : 'ltr'
    return <div className='postCard group text-start '>
        ...
        <div>
            ...
            <div className='flex items-center gap-3 px-4 my-3'>
                ...
                <button onClick={() => setisCommenting(prev => !prev)} className="post-footer-icon hover:text-blue-500"><BiComment />{post?.commentsCount}</button>
